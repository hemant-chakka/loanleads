...
<div class="row">
      <div class="col-lg-12">
        <h1 class="mt-5">Purchase Lead</h1>
        $Content
        <p>You are about to purchase the following lead data</p>
        <% with $Lead %>
	        ...
	        <table class="table table-hover">
  				<tbody>
    				...
    				<tr>
      					<th scope="row"></th>
      					<td colspan="2"><a class="btn btn-primary <% if $CurrentMember && $MemberPurchased %>disabled<% end_if %>" onclick="return confirm('Are you sure you want to do this?');" href="/dashboard/purchaseLead/$ID"  role="button">Confirm Purchase</a></td>
    				</tr>
  				</tbody>
			</table>
			<div id="map"></div>
